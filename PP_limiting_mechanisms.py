...
def plot(save_id = [0]):
    ax[1].set_xticks(range(save_id[0]+1))
    ax[1].set_xticklabels(["One\nResource", "Two\nResources",
                           "Three\nResources",
                           "Zooplankton\nand one\nResource",
                           "Zooplankton\nand two\nResources",
                           "Zooplankton\nand three\nResources"][:save_id[0]+1])
    fig.savefig("PP_slides/PP_limiting_machanisms_{}.png".format(save_id[0]))
    save_id[0] += 1
...
fig.savefig("PP_slides/PP_limiting_machanisms_{}.png".format("end"))
